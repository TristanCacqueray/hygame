...
;; This module provides a clock abstraction implemented by glumpy

(import [glumpy.app [clock :as glumpy-clock]])

(defn Clock [&optional [fps 25]]
  (.set_fps_limit glumpy-clock fps)
  (.get_default glumpy-clock))
